...
def intent_classifier_prompt(message: str, history: Optional[List[ChatMessage]] = None) -> str:
    ...
    parts = [
        ...
        "Use show_writing_prompt only when the user asks to show, quote, or explain what a Writing task requires without composing any part of the response.",
        ...
        "Use solve_questions whenever the user explicitly asks to answer, solve, choose, determine, or give the answer to numbered questions, including when evidence or an explanation is also requested.",
        ...
        '- "What does this Writing Task ask? Do not write the essay" -> show_writing_prompt.',
